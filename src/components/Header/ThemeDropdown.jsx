...
const ThemeDropdown = () => {
  ...
  const [selectedTheme, setSelectedTheme] = useState(themeOptions[0]); // Default to Light Mode
        ...
        <div className="absolute right-1 mt-2 w-40 bg-white border border-gray-300 rounded shadow-lg py-[6px]">
          {themeOptions.map((theme) => (
            <a
              ...
              className="flex items-center px-[15px] py-[7.5px] text-gray-700 text-[14px] hover:bg-gray-100"
            >
